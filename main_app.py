...
class MainApplication:
    ...
    def show_main_screen(self):
        ...
        control_frame.place(relx=0.65, rely=0.45, relwidth=0.33, relheight=0.35)
    ...
    def reset_info_panel(self):
        ...
        if hasattr(self, 'btn_confirm_payment'):
    ...
    def process_payment(self):
        ...
        fee = int(fee_str)
        plate_text = self.info_vars["Biển Số Xe:"].get()
        ...
        messagebox.showinfo("Thành công", f"Xe {plate_text} đã ra khỏi bãi.\nPhí: {fee:,} VNĐ")
